      ...
      <form method="GET" action="<?php echo e(route('maintenance.requests.index')); ?>"
        ...
        <div class="md:col-span-2">
          ...
          <select id="priority" name="priority"
            ...
            <?php $__currentLoopData = ['low'=>'ต่ำ','medium'=>'ปานกลาง','high'=>'สูง','urgent'=>'เร่งด่วน']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <table class="min-w-full text-sm">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <tr class="align-top hover:bg-zinc-50 border-b last:border-0">
            ...
            <td class="p-3 text-zinc-700"><?php echo e($row->reporter?->email ?? ($row->reporter_email ?? '-')); ?></td>
            ...
            <td class="p-3 text-right whitespace-nowrap">
              <div class="flex justify-end items-center gap-2">
                ...
                <a href="<?php echo e(route('maintenance.requests.edit', $row)); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/maintenance/requests/index.blade.php ENDPATH**/ ?>