    ...
    <div class="rounded-xl border border-zinc-200 bg-white p-5">
      ...
      <?php $__empty_1 = true; $__currentLoopData = $logs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="flex items-start justify-between gap-3 border-b py-2">
          <div class="text-xs text-zinc-500 whitespace-nowrap"><?php echo e($log->created_at?->format('Y-m-d H:i')); ?></div>
          <div class="flex-1 min-w-0">
            <div class="text-sm font-medium text-zinc-800"><?php echo e(str_replace('_',' ', ucfirst($log->action))); ?></div>
            <?php if($log->note): ?>
              <div class="text-xs text-zinc-600 truncate"><?php echo e($log->note); ?></div>
            <?php endif; ?>
          </div>
        </div>
    ...
    <div class="rounded-xl border border-zinc-200 bg-white p-5">
      ...
      <?php $__empty_1 = true; $__currentLoopData = $attList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="flex items-center justify-between border-b py-2">
          <div class="truncate text-sm"><?php echo e($att->original_name ?? ('Attachment #'.$att->id)); ?></div>
          <?php if(!empty($att->url)): ?>
            <a href="<?php echo e($att->url); ?>" target="_blank" class="text-emerald-700 hover:underline">Open</a>
          <?php else: ?>
