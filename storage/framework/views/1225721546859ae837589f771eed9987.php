    ...
    <div class="relative overflow-x-auto">
      <table class="min-w-full text-sm">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <?php $isJust = isset($just) && (int)$just === (int)$r->id; ?>
          <tr class="queue-row align-top border-b last:border-0 transition-colors duration-700 <?php echo e($isJust ? 'is-just' : 'hover:bg-zinc-50'); ?>" data-row-id="<?php echo e($r->id); ?>">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/html/resources/views/repair/queue.blade.php ENDPATH**/ ?>