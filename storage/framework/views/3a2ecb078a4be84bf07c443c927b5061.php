      ...
      <div class="flex items-start justify-between gap-4">
        <div class="flex flex-col gap-2">
          <h1 class="text-2xl font-semibold text-slate-900 flex items-center gap-2">
            ...
            Repair work details <span id="rid">#<?php echo e($req->id); ?></span>
          </h1>
  ...
  <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 space-y-6">
      ...
      <div class="p-6">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-4 text-sm">
          ...
          <div>
            ...
            <?php $contactEmail = $req->reporter->email ?? $req->reporter_email; ?>
            <?php if($contactEmail): ?>
              <div class="text-slate-600 text-sm mt-0.5"><?php echo e($contactEmail); ?></div>
            <?php endif; ?>
          </div>
          <div>
          ...
          <div>
            ...
            <div class="font-semibold text-slate-900"><?php echo e($req->location_text ?? '—'); ?></div> 
          </div>
        </div>
    ...
    <section class="rounded-2xl border border-slate-200 bg-white shadow-sm">
      <div class="p-6">
        ...
        <?php $atts = ($req->attachments ?? collect()); ?>
        <?php if($atts->count()): ?>
          <div class="mt-4 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-4">
            <?php $__currentLoopData = $atts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $att): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <figure class="overflow-hidden rounded-lg border border-slate-200">
                <?php if($isImg && !$isPrivate && $att->url): ?>
                  
                  <a href="<?php echo e($openUrl); ?>" target="_blank" rel="noopener">
                    <img src="<?php echo e($att->url); ?>" alt="<?php echo e($att->alt_text ?? $name); ?>" class="h-36 w-full object-cover">
                  </a>
                <?php else: ?>
                ...
                <figcaption class="flex items-center justify-between gap-2 px-3 py-2 text-xs">
                  ...
                  <a href="<?php echo e($openUrl); ?>" <?php echo e($isPrivate ? '' : 'target=_blank rel=noopener'); ?>
