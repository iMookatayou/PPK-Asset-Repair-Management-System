<section class="space-y-4">
    ...
    <form method="post" action="<?php echo e(route('profile.update')); ?>" class="mt-2 space-y-5">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
            <?php if(session('status') === 'profile-updated'): ?>
                <span class="text-sm text-green-600 dark:text-green-400"> <?php echo e(__('Saved.')); ?> </span>
            <?php endif; ?>
        </div>
    </form>
</section>
<?php /**PATH C:\Users\Developer\development\Asset-Repair-Management-System\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>