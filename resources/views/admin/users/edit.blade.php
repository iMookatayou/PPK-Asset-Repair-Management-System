...
<style>
  ...
  /* ตัว item ที่แสดงข้อความที่เลือก ให้ตัดด้วย ... ถ้ายาวเกิน */
  ...
  /* ซ่อน select เดิมที่ TomSelect เปลี่ยนเป็น ts-hidden-accessible */
...
<script>
  document.addEventListener('DOMContentLoaded', function () {
    ...
    // ให้ตรงกับ id ใน _form.blade.php
